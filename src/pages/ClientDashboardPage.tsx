                    ...
                    if (email) {
                        ...
                        if (clientRow?.id) {
                            ...
                            const mapped = (docs || []).map((d: any) => {
                                ...
                                const rel = String(d.file_path || '').replace(/^\/+/, '');
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.8fr 1fr', gap: '24px', marginTop: '48px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div style={sidebarBoxStyle}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                                <div>
                                    <div style={{ height: '116px', borderRadius: '12px', background: 'linear-gradient(135deg, #f1f5f9 25%, #cbd5e1 75%)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #e2e8f0' }}>
